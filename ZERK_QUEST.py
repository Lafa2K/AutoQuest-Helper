...
pLabel("blue", "Blue Zerk (level 95)", 10, 70)
pLabel("blue", "Status", 10, 95)
lblQuestStatus = []
lblQuestStatus.append(pLabel("blue", "Q1: -", 10, 118))
lblQuestStatus.append(pLabel("blue", "Q2: -", 10, 138))
lblQuestStatus.append(pLabel("blue", "Q3: -", 10, 158))
lblQuestStatus.append(pLabel("blue", "Q4: -", 10, 178))
lblQuestStatus.append(pLabel("blue", "Q5: -", 360, 118))
lblQuestStatus.append(pLabel("blue", "Q6: -", 360, 138))
lblQuestStatus.append(pLabel("blue", "Q7: -", 360, 158))
lblQuestStatus.append(pLabel("blue", "Q8: -", 360, 178))

pButton("blue", "btnStartQ1", "QUEST 1", 10, 215)
pButton("blue", "btnStartQ2", "QUEST 2", 110, 215)
pButton("blue", "btnStartQ3", "QUEST 3", 210, 215)
pButton("blue", "btnStartQ4", "QUEST 4", 310, 215)
pButton("blue", "btnStartQ5", "QUEST 5", 10, 250)
pButton("blue", "btnStartQ6", "QUEST 6", 110, 250)
pButton("blue", "btnStartQ7", "QUEST 7", 210, 250)
pButton("blue", "btnStartQ8", "QUEST 8", 310, 250)

pButton("blue", "btnStopQ1", "STOP", 10, 290)
pButton("blue", "btnResumeQuest", "RESUME", 110, 290)
pButton("blue", "btnQuestMobOn", "CHECK QUEST MOB", 210, 290)

pLabel("blue", "Setup", 10, 330)
cbxFindAutomaticPath = pCheckBox("blue", "", "Find automatic path", 10, 355)
QtBind.setChecked(gui, cbxFindAutomaticPath, True)
cbxAutoFixQuestMob = pCheckBox("blue", "", "AutoFix quest mob", 160, 355)
QtBind.setChecked(gui, cbxAutoFixQuestMob, True)
cbxReturnNormal = pCheckBox("blue", "", "Normal return", 310, 355)
cbxReturnSpecial = pCheckBox("blue", "", "Special return", 430, 355)
cbxReturnInstant = pCheckBox("blue", "", "Instant return", 550, 355)
...
lblInventoryStatus = []
lblInventoryStatus.append(pLabel("inventory", "Q1: -", 10, 118))
lblInventoryStatus.append(pLabel("inventory", "Q2: -", 10, 138))
lblInventoryStatus.append(pLabel("inventory", "Q3: -", 10, 158))
lblInventoryStatus.append(pLabel("inventory", "Q4: -", 10, 178))
pButton("inventory", "btnStartInvQ1", "QUEST 1", 10, 215)
pButton("inventory", "btnStartInvQ2", "QUEST 2", 110, 215)
pButton("inventory", "btnStartInvQ3", "QUEST 3", 210, 215)
pButton("inventory", "btnStartInvQ4", "QUEST 4", 310, 215)
pButton("inventory", "btnStopQ1", "STOP", 10, 250)
pButton("inventory", "btnResumeInventory", "RESUME", 110, 250)
pLabel("inventory", "Setup", 10, 290)
cbxInventoryReverseWind = pCheckBox("inventory", "", "Use Reverse Scroll: Wind Town", 10, 315)
pLabel("inventory", "Training areas: attack radius 25 / pick radius 50. Return uses selected Blue Zerk return checkbox.", 10, 350)
...
INVENTORY_NPC_ARRIVAL_DISTANCE = 16.0
